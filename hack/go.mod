...
require (
	github.com/aperturerobotics/entitygraph v0.9.1
...
require (
	...
	github.com/aperturerobotics/controllerbus v0.45.3 // indirect
	github.com/aperturerobotics/protobuf-go-lite v0.6.5 // indirect
